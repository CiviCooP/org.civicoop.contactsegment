...
/**
 * SegmentSetting.Create API specification (optional)
 ...
 */
function _civicrm_api3_segment_setting_create_spec(&$spec) {
...
function civicrm_api3_segment_setting_create($params) {
  ...
  return civicrm_api3_create_success($segmentSetting->add($params), $params, 'SegmentSetting', 'Create');
}
